...
public abstract class Hilt_RewardsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RewardsFragment() {
    super();
  }

  Hilt_RewardsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RewardsFragment_GeneratedInjector) this.generatedComponent()).injectRewardsFragment(UnsafeCasts.<RewardsFragment>unsafeCast(this));
    }
  }
