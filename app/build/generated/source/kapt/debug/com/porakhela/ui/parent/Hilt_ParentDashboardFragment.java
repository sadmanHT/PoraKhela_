...
public abstract class Hilt_ParentDashboardFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ParentDashboardFragment() {
    super();
  }

  Hilt_ParentDashboardFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ParentDashboardFragment_GeneratedInjector) this.generatedComponent()).injectParentDashboardFragment(UnsafeCasts.<ParentDashboardFragment>unsafeCast(this));
    }
  }
