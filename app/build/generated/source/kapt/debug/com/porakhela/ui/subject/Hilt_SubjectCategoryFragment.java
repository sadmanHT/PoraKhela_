...
public abstract class Hilt_SubjectCategoryFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SubjectCategoryFragment() {
    super();
  }

  Hilt_SubjectCategoryFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SubjectCategoryFragment_GeneratedInjector) this.generatedComponent()).injectSubjectCategoryFragment(UnsafeCasts.<SubjectCategoryFragment>unsafeCast(this));
    }
  }
