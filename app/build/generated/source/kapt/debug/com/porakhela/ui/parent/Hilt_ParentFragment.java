...
public abstract class Hilt_ParentFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ParentFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ParentFragment_GeneratedInjector) this.generatedComponent()).injectParentFragment(UnsafeCasts.<ParentFragment>unsafeCast(this));
    }
  }
