...
public abstract class Hilt_LessonsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_LessonsFragment() {
    super();
  }

  Hilt_LessonsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LessonsFragment_GeneratedInjector) this.generatedComponent()).injectLessonsFragment(UnsafeCasts.<LessonsFragment>unsafeCast(this));
    }
  }
