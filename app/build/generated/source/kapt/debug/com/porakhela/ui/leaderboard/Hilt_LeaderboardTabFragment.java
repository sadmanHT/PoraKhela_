...
public abstract class Hilt_LeaderboardTabFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_LeaderboardTabFragment() {
    super();
  }

  Hilt_LeaderboardTabFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LeaderboardTabFragment_GeneratedInjector) this.generatedComponent()).injectLeaderboardTabFragment(UnsafeCasts.<LeaderboardTabFragment>unsafeCast(this));
    }
  }
