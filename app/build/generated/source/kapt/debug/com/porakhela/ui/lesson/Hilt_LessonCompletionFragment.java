...
public abstract class Hilt_LessonCompletionFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_LessonCompletionFragment() {
    super();
  }

  Hilt_LessonCompletionFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LessonCompletionFragment_GeneratedInjector) this.generatedComponent()).injectLessonCompletionFragment(UnsafeCasts.<LessonCompletionFragment>unsafeCast(this));
    }
  }
