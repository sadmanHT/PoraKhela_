...
public abstract class Hilt_LeaderboardFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_LeaderboardFragment() {
    super();
  }

  Hilt_LeaderboardFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LeaderboardFragment_GeneratedInjector) this.generatedComponent()).injectLeaderboardFragment(UnsafeCasts.<LeaderboardFragment>unsafeCast(this));
    }
  }
