...
public abstract class Hilt_ParentPinAuthFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ParentPinAuthFragment() {
    super();
  }

  Hilt_ParentPinAuthFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ParentPinAuthFragment_GeneratedInjector) this.generatedComponent()).injectParentPinAuthFragment(UnsafeCasts.<ParentPinAuthFragment>unsafeCast(this));
    }
  }
