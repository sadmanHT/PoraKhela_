...
public abstract class Hilt_LessonPlayerFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_LessonPlayerFragment() {
    super();
  }

  Hilt_LessonPlayerFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LessonPlayerFragment_GeneratedInjector) this.generatedComponent()).injectLessonPlayerFragment(UnsafeCasts.<LessonPlayerFragment>unsafeCast(this));
    }
  }
